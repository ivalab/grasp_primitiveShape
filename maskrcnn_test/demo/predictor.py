...
class COCODemo(object):
    ...
    def run_on_opencv_image(self, image,img_show):
        ...
        result,top_predictions2 = self.overlay_boxes(result, top_predictions)
        result,mask_output = self.overlay_mask(result, top_predictions2)

        result = self.overlay_class_names(result, top_predictions2)
    ...
    def overlay_boxes(self, image, predictions):
        ...
        keep_nms = torchvision.ops.nms(boxes, scores, 0.55)
