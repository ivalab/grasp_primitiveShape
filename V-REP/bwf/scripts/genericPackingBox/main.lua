    ...
    function sysCall_init()
        ...
        if isCustomizationScript then
            ...
            if model.modelVersion==1 then
                ...
                -- Box specific:
                require("/bwf/scripts/genericPackingBox/common")
                require("/bwf/scripts/genericPackingBox/customization_main")
                require("/bwf/scripts/genericPackingBox/customization_dlg")
            end
        else
            -- Child script
